    ...
    <div className='relative font-[Regular] text-white'>
     <div className="relative z-30">
      ...
      <div className="w-full px-5 mt-7">
        <div className="p-5 relative max-w-[1350px] h-[600px] mx-auto rounded-[4px] flex items-center justify-center border-2 border-[#621CD4] overflow-hidden">
     ...
     <div className="px-5 relative max-w-[1350px] mx-auto mt-[220px]">
      <div className="relative z-30">
        <div className="relative flex items-center justify-center flex-col text-center">
          ...
          <div className="my-1 font-[ClashDisplay-Semibold] text-[40px]">Endless quests and thrilling challenges</div>
        ...
        <div className="relative flex items-center justify-center flex-col text-center mt-[150px]">
          ...
          <div className="my-1 font-[ClashDisplay-Semibold] text-[40px]">Online PVP Battles</div>
        ...
        <div className="relative flex items-center justify-center flex-col text-center mt-[150px]">
          ...
          <div className="text-[#55DBD6] text-[19px] tracking-wide mt-3">Join a community of players from around the world</div>
          <div className="my-1 font-[ClashDisplay-Semibold] text-[40px]">BEST COMMUNITY SUPPORT</div>
     ...
     <img src="/images/planet1.svg" className='absolute -top-[100px] left-0' alt="planet" />
     <img src="/images/planet2.svg" className='absolute top-1/2 -translate-y-1/2 right-0' alt="planet" />
     <img src="/images/cat-plane.svg" className='absolute bottom-0 left-0 w-[260px]' alt="cat plane" />
     </div>
     ...
     <div className="px-5 relative max-w-[1350px] mx-auto mt-[150px]">
       <div className="relative mb-12">
        <div className="relative font-[ClashDisplay-Semibold] text-[35px] bg-[#100228] w-fit mx-auto text-center px-6 z-20 leading-none">BEST COMMUNITY SUPPORT</div>
     ...
     <div className="relative px-5 max-w-[1350px] mx-auto h-[200px] mt-[170px]"><img src="/images/planet3.svg" className='absolute top-0 left-0' alt="planet" /></div>
     
     <img src="/images/background4.svg" className='w-full' alt="background" />

     <div className="bg-[#100228] px-5 max-w-[1350px] mx-auto py-5 flex items-center justify-between gap-3">
